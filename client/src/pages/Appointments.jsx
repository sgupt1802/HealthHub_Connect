                  ...
                  {appointments?.map((ele, i) => {
                    return (
                      <tr key={ele?._id}>
                        ...
                        <td>{new Date(ele?.createdAt).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}</td>
                        <td>{new Date(ele?.updatedAt).toLocaleTimeString('en-IN', { timeZone: 'Asia/Kolkata', hour: '2-digit', minute: '2-digit' })}</td>
